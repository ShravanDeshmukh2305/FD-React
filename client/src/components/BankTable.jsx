...
//   const [newBank, setNewBank] = useState(null); // Track if we're adding a new row
//   const [isEditing, setIsEditing] = useState(null); // Track editing state for inline edits

//   // Fetch banks from the database on component mount
//   useEffect(() => {
...
//   // Handle input change for both new and existing banks
...
//       <button className="add-button" onClick={() => setNewBank({ bankName: "", city: "", state: "", branch: "" })}>
//         Add Bank
//       </button>
...
//                     name="bankName"
//                     value={bank.bankName}
//                     onChange={(e) => handleInputChange(e, bank._id)}
//                   />
//                 ) : (
//                   bank.bankName
//                 )}
